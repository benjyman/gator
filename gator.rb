...
def check_rts_status(path: ".")
    ...
    if not stdout_log
        stokes_I_filenames=Dir.glob("#{path}/*image.fits")
    ...
    def rts_setup(mins: 10,
        ...
        if obs_semester=='2015A' or obs_semester=='2015B'
            ...
            if @type == "moon"
                ...
                wsclean_options_string='--wsclean_options=" -auto-threshold 1 -auto-mask 3 -multiscale -niter 1000000 -mgain 0.85 -save-source-list -datacolumn CORRECTED_DATA  -scale 0.0085 -weight uniform  -smallinversion  -channelsout 24 -join-channels -fit-spectral-pol 2 -make-psf   "'
            else
